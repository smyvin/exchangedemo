...
@SpringBootTest
@ActiveProfiles("test")
public class ExchangeDemoApplicationMainTests {
	...
	public void balances(){
		...
		assertThat(c1.getBalanceDollar()).isEqualTo(838);
		assertThat(c2.getBalanceDollar()).isEqualTo(1182);
		assertThat(c3.getBalanceDollar()).isEqualTo(980);

		assertThat(c1.getBalance("A")).isEqualTo(104);
		assertThat(c1.getBalance("B")).isEqualTo(107);
		assertThat(c1.getBalance("C")).isEqualTo(100);
		assertThat(c1.getBalance("D")).isEqualTo(105);

		assertThat(c2.getBalance("A")).isEqualTo(100);
		assertThat(c2.getBalance("B")).isEqualTo(96);
		assertThat(c2.getBalance("C")).isEqualTo(95);
		assertThat(c2.getBalance("D")).isEqualTo(95);

		assertThat(c3.getBalance("A")).isEqualTo(96);
		assertThat(c3.getBalance("B")).isEqualTo(97);
		assertThat(c3.getBalance("C")).isEqualTo(105);
