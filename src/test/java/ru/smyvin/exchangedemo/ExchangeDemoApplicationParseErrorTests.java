...
@SpringBootTest(properties = {"data.order=classpath:data/orders-test-3.txt"})
@ActiveProfiles("test")
public class ExchangeDemoApplicationParseErrorTests {
	...
	public void balances(){
		...
		assertThat(c1.getBalanceDollar()).isEqualTo(800);
		assertThat(c2.getBalanceDollar()).isEqualTo(1000);
		assertThat(c3.getBalanceDollar()).isEqualTo(1200);

		assertThat(c1.getBalance("A")).isEqualTo(120);
		...
		assertThat(c3.getBalance("A")).isEqualTo(80);
